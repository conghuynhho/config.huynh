...
# Timeout load terminal-icons

# Register an event handler to run after the terminal is ready.
# This is useful for modules that need to do some work after the terminal is ready.
# For example, terminal-icons needs to know the terminal size to render the icons.
# This event handler will be called after the terminal is ready.
function loadIcon {
    # Import the module
    Import-Module Terminal-Icons
}
set-alias icon loadIcon
